...
public class RedAstronaut extends Player implements Impostor{
    ...
    //A sabotage can't happen if target player, saboteur, are frozen, or if target is not an impostor
    //else. if saboteur has suslevel below 20, target suslevel increases by 50%, else by 25%
    @Override
